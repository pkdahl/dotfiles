...
now doing =pip3 install --user [package]= will install package to ~/.local/lib/python/site-pacakges
and any binaries to ~/.local/bin

python module =site= have function getuserbase()
